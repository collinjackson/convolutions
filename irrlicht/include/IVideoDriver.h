...
namespace video
{
	...
	*/
	...
	public:
		...
		// Create stereogram with glyphs and reset it
		virtual stereogram::Stereogram* createStereogram() = 0;
		virtual void readDepth(f32* buffer) = 0;
		virtual void writeColor(u8* buffer) = 0;
	};
