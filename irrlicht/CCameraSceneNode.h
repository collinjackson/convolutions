...
namespace scene
{
	...
	public:
		...
		//virtual void setViewMatrix(const core::matrix4& v);
		...
		virtual void setKeyInputReceiverEnabled(bool enabled);
		virtual void setMouseInputReceiverEnabled(bool enabled);
	...
	protected:
		...
		bool KeyInputReceiverEnabled;
		bool MouseInputReceiverEnabled;
