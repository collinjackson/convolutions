			...
			core::vector3df(1.0f, 1.0f, 1.0f)), InputReceiverEnabled(true)
{
	...
	fovy = core::PI / 3.5f;	// Field of view, in radians. 
...
void CCameraSceneNode::setMouseInputReceiverEnabled(bool enabled)
{
	MouseInputReceiverEnabled = enabled;
}


void CCameraSceneNode::setKeyInputReceiverEnabled(bool enabled)
{
	KeyInputReceiverEnabled = enabled;
}
...
//void CCameraSceneNode::setViewMatrix(const core::matrix4& v)
//{
//	View = v;
//}
